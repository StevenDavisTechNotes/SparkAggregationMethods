from spark_agg_methods_common_python.perf_test_common import (
    ...
    SolutionInterfacePythonOnly, SolutionInterfaceScalaSpark, SolutionLanguage,
)
...
from src.challenges.six_field_test_data.six_test_data_for_pyspark import (
    SixFieldChallengeMethodPythonPysparkRegistration, SixFieldChallengeMethodScalaSparkRegistration,
