...
def write_failed_run(test_method: PythonTestMethod, result: RunResult, file: TextIO):
...
def write_run_result(success: bool, test_method: PythonTestMethod, result: RunResult, file: TextIO):
