...
from src.challenges.vanilla.strategies.using_dask.vanilla_dask_bag_accumulate import (
    vanilla_dask_bag_accumulate,
)
from src.challenges.vanilla.strategies.using_dask.vanilla_dask_bag_fold import (
    vanilla_dask_bag_fold,
)
from src.challenges.vanilla.strategies.using_dask.vanilla_dask_bag_foldby import (
    vanilla_dask_bag_foldby,
)
from src.challenges.vanilla.strategies.using_dask.vanilla_dask_bag_map_partitions import (
    vanilla_dask_bag_map_partitions,
)
from src.challenges.vanilla.strategies.using_dask.vanilla_dask_bag_reduction import (
    vanilla_dask_bag_reduction,
)
from src.challenges.vanilla.strategies.using_dask.vanilla_dask_ddf_grp_apply import (
    vanilla_dask_ddf_grp_apply,
)
from src.challenges.vanilla.strategies.using_dask.vanilla_dask_ddf_grp_udaf import (
    vanilla_dask_ddf_grp_udaf,
)
from src.challenges.vanilla.strategies.using_dask.vanilla_dask_sql import (
    vanilla_dask_sql_no_gpu,
)

VANILLA_STRATEGY_REGISTRY_DASK: list[ChallengeMethodPythonDaskRegistration] = [
    ChallengeMethodPythonDaskRegistration(
