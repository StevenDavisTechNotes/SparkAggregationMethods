...
from src.challenges.vanilla.strategies.queue_mediated.vanilla_py_mt_queue_pd_prog_1_reader_numpy import (
...
VANILLA_STRATEGIES_USING_PYTHON_ONLY_REGISTRY: list[ChallengeMethodPythonOnlyRegistration] = [
    ChallengeMethodPythonOnlyRegistration(
        ...
        strategy_name=name_of_function(vanilla_py_mt_queue_pd_prog_1_reader_numpy),
        ...
        requires_gpu=False,
        delegate=vanilla_py_mt_queue_pd_prog_1_reader_numpy,
    ),
    ChallengeMethodPythonOnlyRegistration(
        strategy_name_2018=None,
